...
export default function Professional() {
  const handleClickbProf = () => {
    gsap.to('.xcontainer', { x: '-100vw', duration: 1 });
  };
      ...
      <div className='flex flex-row w-full h-full opacity-[80%]'>
        ...
        <div className='text-white text-[20px] font-haaslight flex flex-col justify-evenly h-[85vh]'>
          ...
          <div
            ...
            className=' underline decoration-1 underline-offset-[6px] mr-6 self-end'
          >
            go back
          </div>
          <div className='w-[80%] ml-[10%] mt-[10%]'>
            ...
            good life. And nobody is able to stop you.”-
            <span className=' '>Marcus Aurelius</span>
            {/* bold this, add bolded font*/}
          </div>
        </div>
      </div>
    </div>
